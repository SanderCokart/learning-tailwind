...
export default function ContactUs() {
    ...
    return <section className="p-6 my-12 scroll-mt-20 widescreen:section-min-height tallscreen:section-min-height" id="contact">
        ...
        <form className="max-w-4xl mx-auto text-2xl sm:text-3xl flex flex-col items-left gap-4" onSubmit={onSubmit}>
            ...
            <button
                className="bg-red-500 hover:bg-red-600 active:bg-red-500 text-white p-3 w-48 rounded-xl border border-solid border-slate-900 dark:border-none">
                Submit
            </button>
        </form>
        <pre>
